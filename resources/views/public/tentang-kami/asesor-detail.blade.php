    ...
    <div>
        <section class="bg-white mt-20">
            <div class="max-w-2xl px-6 text-center mx-auto">
                <h2 class="text-3xl font-semibold text-gray-800">{{ $assessor['data']['name'] }}</h2>
                <div class="flex items-end justify-center mt-16">
                    <img src="{{ !empty($assessor['data']['profile_picture']) ? $assessor['data']['profile_picture'] : asset('images/no-photo.png') }}">
            </div>
        </section>
        <section class="bg-gray-800 pattern py-20">
            <div class="max-w-5xl px-6 mx-auto text-center">
                <h2 class="text-2xl font-semibold text-white">Wilayah Asesor</h2>
                <p class="text-gray-400 mt-4">
                    {{ $assessor['data']['region']['name'] ?? '' }}
                </p>
            </div>
        </section>
    </div>
