...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
    <div class="d-block mb-4 mb-md-0">
        ...
        <h2 class="h4">Input Data Berita</h2>
    </div>
</div>
    ...
    <div class="card-body">
        <form action="{{ route('admin.berita.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group row mb-2">
                ...
                <div class="col-md-9">
                    <input class="form-control" name="published_date" type="datetime-local" required/>
                </div>
            </div>
            <div class="form-group row mb-2">
                <div class="col-md-3">
                ...
                <div class="col-md-9">
                    <textarea name="body" class="form-control" id="summernote" cols="30" rows="10"></textarea>
                </div>
            </div>
            <div class="form-group row mb-2">
                <div class="col-md-3 required">
                ...
                <div class="col-md-9">
                    <input class="form-control" name="image_file" type="file" accept=".jpg, .jpeg, .png" required/>
                    <small class="text-danger">*Orientasi foto landscape, ukuran foto disarankan 600x400</small>
                </div>
            </div>
            <div class="form-group row text-center">
                <div class="col-md-12">
                    <x-buttons.save :title="__('Save Berita')"/>
