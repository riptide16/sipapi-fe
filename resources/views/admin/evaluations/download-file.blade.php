    ...
    <div class="d-block mb-4 mb-md-0">
        <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
            <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
                ...
                <li class="breadcrumb-item active" aria-current="page">Download File Penilaian</li>
            </ol>
        </nav>
...
<div class="card border-0 shadow mb-4">
    <div class="card-body">
        <div class="form-group mb-2">
            ...
            <div class="col-md-9">
                <x-forms.label class="text-info" :label="session('getFetchDataEvaluation')['data'][0]['accreditation']['code']"/>
            </div>
        </div>
        <div class="form-group mb-2">
            <div class="col-md-3">
            ...
            <div class="col-md-9">
                <x-forms.label class="text-info" :label="session('getFetchDataEvaluation')['data'][0]['accreditation']['institution']['library_name']"/>
            </div>
        </div>
        <hr>
    </div>
