...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
    <div class="d-block mb-4 mb-md-0">
        ...
        <h2 class="h4">Show Data Email Template</h2>
    </div>
</div>
    ...
    <div class="card-body">
        <form>
            ...
            <div class="form-group row mb-2">
                ...
                <div class="col-md-9">
                    <x-forms.input name="subject" value="{{ $fetchData['data']['subject'] }}" disabled/>
                </div>
            </div>
            <div class="form-group row mb-2">
                <div class="col-md-3 required">
                ...
                <div class="col-md-9">
                    <x-forms.input name="action_button" value="{{ $fetchData['data']['action_button'] }}" disabled/>
                </div>
            </div>
            <div class="form-group row mb-2">
                <div class="col-md-3 required">
                ...
                <div class="col-md-9">
                    <x-forms.input name="body" value="{{ $fetchData['data']['body'] }}" disabled/>
                </div>
            </div>
