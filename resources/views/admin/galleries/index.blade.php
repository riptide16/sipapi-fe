...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
    <div class="d-block mb-4 mb-md-0">
        ...
        <h2 class="h4">Data Gallery</h2>
    </div>
    <div class="btn-toolbar mb-2 mb-md-0">
        <x-buttons.create :href="route('admin.galeri.create')" :title="__('Gallery')" />
    </div>
</div>
            ...
            <table id="datatable" class="table table-centered table-nowrap mb-0 rounded">
                <thead class="thead-light">
                    <tr>
                        ...
                        <th class="border-0">Publish Date</th>
                        <th class="border-0">Album</th>
                ...
                <tbody>
                    ...
                    @forelse ($fetchData['data'] as $item)
                        <tr>
                            ...
                            <td>{{ date('d/m/Y H:i:s', strtotime($item['published_date'])) }}</td>
