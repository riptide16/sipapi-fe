...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
    <div class="d-block mb-4 mb-md-0">
        ...
        <h2 class="h4">Edit Data Kecamatan</h2>
    </div>
</div>
<div class="card border-0 shadow mb-4">
    <div class="card-body">
        <form action="{{ route('admin.master_data.subdistricts.update', ['id' => $subdistrict['id']]) }}" method="POST">
            @csrf
            @method('put')
            <div class="form-group row mb-2">
                ...
                <div class="col-md-9">
                    <x-forms.select-province :placeholder="__('Provinsi')" :fill="__($fetchDataProvince['data']['id'])" name="province_id" required/>
                </div>
            </div>
            <div class="form-group row mb-2">
                <div class="col-md-3">
                ...
                <div class="col-md-9">
                    <x-forms.select-city :placeholder="__('City')" :fill="__($subdistrict['city']['id'])" name="city_id" required/>
                </div>
            </div>
            <div class="form-group row mb-2">
                <div class="col-md-3">
                ...
                <div class="col-md-9">
                    <x-forms.input name="name" value="{{ $subdistrict['name'] }}" required/>
                </div>
            </div>
