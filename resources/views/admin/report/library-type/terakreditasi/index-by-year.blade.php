...
<div class="card border-0 shadow mb-4">
    <div class="card-header">
        <h2 class="card-title">Report Jumlah Terakreditasi Berdasarkan Jenis Perpustakaan Per Tahun</h2>
...
@push('js')
    <script>
        const url = "{{ route('admin.report.library_type.terakreditasi_in_year.by_year') }}"
