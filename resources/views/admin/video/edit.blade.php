...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
    <div class="d-block mb-4 mb-md-0">
        ...
        <h2 class="h4">Edit Data Video</h2>
    </div>
</div>
    ...
    <div class="card-body">
        <form action="{{ route('admin.video.update', ['id' => $video['id']]) }}" method="POST">
            ...
            <div class="form-group row mb-2">
                ...
                <div class="col-md-9">
                    <input class="form-control" name="youtube_id" value="{{ $video['youtube_id'] }}" required/>
                </div>
            </div>
            <div class="form-group row mb-2">
                <div class="col-md-3">
                ...
                <div class="col-md-9">
                    <textarea name="Description" class="form-control" cols="30" rows="10">{{ $video['description'] }}</textarea>
                </div>
            </div>
            <div class="form-group row mb-2">
                <div class="col-md-3">
                ...
                <div class="col-md-9">
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="is_homepage" value="1" {{ $video['is_homepage'] == 1 ? 'checked' : '' }}>
                        <label class="form-check-label">Ya</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="is_homepage" value="0" {{ $video['is_homepage'] == 0 ? 'checked' : '' }}>
            ...
            <div class="form-group row text-center">
                <div class="col-md-12">
                    <x-buttons.save :title="__('Edit Video')"/>
