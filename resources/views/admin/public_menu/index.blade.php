...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
    <div class="d-block mb-4 mb-md-0">
        ...
        <h2 class="h4">Data Menu</h2>
    </div>
    <div class="btn-toolbar mb-2 mb-md-0">
        <x-buttons.create :href="route('admin.content-website.public-menu.create')" :title="__('Menu')" />
    </div>
</div>
<nav>
    <div class="nav nav-tabs" id="nav-tab" role="tablist" style="border: none;">
        <a class="nav-link active" href="{{ route('admin.content-website.public-menu.index') }}" id="nav-home-tab">Menu</a>
        <a class="nav-link" href="{{ route('admin.content-website.page.index') }}" id="nav-home-tab">Halaman</a>
    </div>
</nav>
                        ...
                        <tr>
                            ...
                            <td>
                                @include('components.general-actions-resource', [
                                    'route' => 'admin.content-website.public-menu',
                                    'id' => $item['id'],
                                    'model' => 'public_menu',
                                    'actions' => [
                                        'edit' => true,
